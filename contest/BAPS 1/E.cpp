...
{ freopen("crypto.in","r",stdin);
    ...
    while(scanf("%lld %lld %lld",&n,&a,&b)==3){
            ...
            while(j<=n){
                ...
                if((i&j)==i || (i&j)==j){
                    if((i&j)==i){
                        ...
                        x=i;
                        y=j;
                    } //printf("now x=%lld y=%lld\n",x,y);

                    if((((x*a)+(y*b))^((y*a)+(x*b)))>mx){
                    mx=(((x*a)+(y*b))^((y*a)+(x*b)));
                    ansx=x;
                    ansy=y; //printf("mx=%lld x=%lld y=%lld\n",mx,ansx,ansy);
                }


                if((((x*a)+(x*b))^((x*a)+(x*b)))>mx){
                    mx=(((x*a)+(x*b))^((x*a)+(x*b)));
                    ansx=x;
                    ansy=x; //printf("mx=%lld x=%lld y=%lld\n",mx,ansx,ansy);
                }

                if((((y*a)+(y*b))^((y*a)+(y*b)))>mx){
                    mx=(((y*a)+(y*b))^((y*a)+(y*b)));
                    ansx=y;
                    ansy=y; //printf("mx=%lld x=%lld y=%lld\n",mx,ansx,ansy);
                }
        ...
        printf("%lld %lld\n",ansx,ansy);
//        mx=(((15*a)+(10*b))^((10*a)+(15*b)));printf("final mx=%lld\n",mx);
//        mx=(((10*a)+(15*b))^((15*a)+(10*b)));printf("final mx=%lld\n",mx);
//        printf("%lld %lld = %lld\n",15ll,10ll,15ll&10ll);
    }
