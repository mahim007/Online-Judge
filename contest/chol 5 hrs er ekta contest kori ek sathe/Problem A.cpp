...
void dfs(ll u,ll v,ll col){
    ...
    for(ll i=0;i<4;i++){
        ...
        if(valid(vx,vy)==0 || g[u][v]!=g[vx][vy] || vis[vx][vy]!=-1) continue;
        dfs(vx,vy,col);
    }
}
...
int main()
{
    ...
    for(i=1;i<=n;i++){
        ...
        if(g[r1][c1]!=g[r2][c2]) cout<<"neither\n";
        else if(g[r1][c1]==g[r2][c2] && g[r1][c1]=='0'){
            if(vis[r1][c1]==vis[r2][c2]) cout<<"binary\n";
            else cout<<"neither\n";
        }
        else if(g[r1][c1]==g[r2][c2] && g[r1][c1]=='1'){
            if(vis[r1][c1]==vis[r2][c2]) cout<<"decimal\n";
            else cout<<"neither\n";
        }
    }
