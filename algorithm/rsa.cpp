...
int main()
{
    ...
    ll T,t;
    ll i,j,k;
    ll n,m,q,p,phii,d,e,u,v,a,b; //cout<<big_mod(2,4,10)<<"\n\n";
    cout<<"p=";cin>>p;
    cout<<"q=";cin>>q;
    n=p*q; cout<<"n="<<n<<"\n";
    phii=(p-1)*(q-1); cout<<"phi(n)="<<phii<<"\n";
    cout<<"e=";cin>>e;
    cout<<"d=";cin>>d;
    ...
    ll c=((big_mod(m,e,n)))%n;
    cout<<"encrypted message c="<<c<<"\n";

    v=big_mod(u,phii-a,n);cout<<"v="<<v<<"\n";
    //ll y=big_mod(v,phii-b,n);cout<<"y="<<y<<"\n";

    cout<<(big_mod(c,d,n))<<" "<<big_mod(v,e*d,n)<<"\n";
    ll ans=(big_mod(c,d,n))%n;
    cout<<"decrypted message is="<<ans<<"\n";
