...
int main()
{
    ...
    for(i=2;i<n;i=i+2) dif1[i]=-dif1[i];
    for(i=1;i<n;i=i+2) dif2[i]=-dif2[i];

//    for(i=1;i<n;i++) printf("%lld ",dif1[i]);printf("\n");
//    for(i=1;i<n;i++) printf("%lld ",dif2[i]); printf("\n");

    printf("%lld\n",max(kadane(dif1,n-1),kadane(dif2,n-1)));
    return 0;
}
